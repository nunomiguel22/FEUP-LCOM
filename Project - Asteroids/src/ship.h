...
typedef struct {
	mpoint position; 			/**< @brief Laser x/y position */
	mvector force;				/**< @brief Vector with force applied to the laser's position */
	bool active;				/**< @brief Laser status */
}weapon;

 /** @brief Player struct */
typedef struct {
	mpoint cannon;				/**< @brief Cannon x/y position */
	mpoint pivot;				/**< @brief Pivot (center of ship) x/y position */
	mvector port;				/**< @brief Versor with port engine direction */
	mvector starboard;			/**< @brief Versor with starboard engine direction */
	mvector force;				/**< @brief Vector with force applied to the ship's position */
	mpoint crosshair;			/**< @brief Crosshair x/y position */		
